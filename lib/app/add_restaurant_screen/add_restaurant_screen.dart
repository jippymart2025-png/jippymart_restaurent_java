...
import 'package:jippymart_restaurant/app/add_restaurant_screen/qr_code_screen.dart';
import 'package:jippymart_restaurant/constant/constant.dart';
import 'package:jippymart_restaurant/constant/show_toast_dialog.dart';
import 'package:jippymart_restaurant/controller/add_restaurant_controller.dart';
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: DropdownSearch<VendorCategoryModel>.multiSelection(
                                    ...
                                    popupProps: PopupPropsMultiSelection.dialog(  // Change to dialog mode
                                      ...
                                      showSearchBox: true,  // Optional: Add search functionality
                                      searchFieldProps: TextFieldProps(
                                        decoration: InputDecoration(
                                          hintText: 'Search...'.tr,
                                          hintStyle: TextStyle(
                                            color: themeChange.getThem() ? AppThemeData.grey100 : AppThemeData.grey700,
                                          ),
                                        ),
                                      ),
                                      ...
                                      itemBuilder: (context, item, isSelected) {
                                        return Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: isSelected ? AppThemeData.secondary300.withOpacity(0.2) : Colors.transparent,
